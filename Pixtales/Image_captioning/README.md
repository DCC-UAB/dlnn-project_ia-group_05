...
{'<SOS> a man in a blue shirt and a black shirt is standing in front of a crowd . <EOS>': 0.9090909090909091, '<SOS> a man in a black shirt and a black hat is standing in front of a building . <EOS>': 1.0, '<SOS> a man in a blue shirt is standing on a bench with a <UNK> in the background . <EOS>': 1.1428571428571428, '<SOS> a man and a woman are sitting on a bench in front of a building . <EOS>': 1.2, '<SOS> a man in a blue shirt is standing on a bench with a man in a black shirt . <EOS>': 1.2, '<SOS> a man in a blue shirt is standing on a bench with a white dog . <EOS>': 1.2, '<SOS> a young boy in a blue shirt is jumping into a pool . <EOS>': 1.2, '<SOS> a man in a black shirt and a black shirt is standing in front of a building . <EOS>': 1.2222222222222223, '<SOS> a man in a blue shirt is standing on a bench with a black and white dog . <EOS>': 1.25, '<SOS> a man in a red shirt is riding a bike down a road . <EOS>': 1.25, '<SOS> a man in a blue shirt is standing on a rock . <EOS>': 1.25, '<SOS> a young boy wearing a blue shirt is holding a red toy . <EOS>': 1.25, '<SOS> a man in a red shirt and a black shirt is standing in front of a crowd . <EOS>': 1.25, '<SOS> a man in a black shirt is standing on a bench with a <UNK> in the background . <EOS>': 1.3333333333333333, '<SOS> a man is standing on a bench with a man in a black shirt and a black hat . <EOS>': 1.3333333333333333, '<SOS> a man in a blue shirt and a blue shirt is standing in front of a building . <EOS>': 1.3333333333333333, '<SOS> a man in a blue shirt is standing on a sidewalk with a man in a white shirt and a black hat . <EOS>': 1.4, '<SOS> a man in a red shirt is standing on a bench with a man in a white shirt and a black hat . <EOS>': 1.5, '<SOS> a group of people are sitting on a bench . <EOS>': 2.0, '<SOS> a boy in a blue shirt and a blue shirt is sitting on a bench . <EOS>': 2.0}
...
And finally the image caption evaluation. Remember how we said the loss would get down really slow, about 0.03 for each epoch. We think we are falling into a local minima or some place that leads to a solution that looks tribial to the model since most of the time, the caption is the same:
